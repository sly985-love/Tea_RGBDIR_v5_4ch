...
def train(hyp, opt, device, tb_writer=None):
    ...
    # Model, modded with 4 channel support. 
    ...
    if pretrained:
        ...
        model = Model(opt.cfg, ch=4, nc=nc, anchors=hyp.get('anchors')).to(device)  # create
    with torch_distributed_zero_first(rank):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5s_ch4.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/voc_tea_rgba_ir.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--project', default=r'/home/ps/rgbd/result/yolov5_ch4_27', help='save to project/name')
